...
@TeleOp
public class Centerstage_V4 extends LinearOpMode {
    boolean debug = false;
    ...
    public void runOpMode() {
        ...
        Servo leftC = hardwareMap.get(Servo.class, "clawLeft");
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad2.b){
                ...
                //claw.close();
                rightC.setPosition(0.43);
                leftC.setPosition(0.47);
                debugLog("Claw Close");
            }
